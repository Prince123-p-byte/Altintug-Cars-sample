...
// ============ GAUGE COUNT-UP ============
// Reflect the real inventory count instead of a hardcoded number.
const gaugeAvailableEl = document.getElementById('gaugeAvailable');
if(gaugeAvailableEl) gaugeAvailableEl.dataset.count = vehicles.length;
const heroSubEl = document.getElementById('heroSub');
if(heroSubEl) heroSubEl.textContent = `${vehicles.length} curated vehicles, from certified pre-owned daily drivers to limited-run performance machines. Every listing inspected, priced transparently, ready this week.`;
